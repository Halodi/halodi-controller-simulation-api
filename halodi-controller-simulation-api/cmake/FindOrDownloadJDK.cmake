...
if(JNI_FOUND)
    ...
    set(JNI_LIBRARIES jvm)
    if(WIN32)
        link_directories("${source_dir}/jre/bin/server")
    elseif(APPLE)
        link_directories("${source_dir}/jre/lib/server")
    else()
        link_directories("${source_dir}/jre/lib/amd64/server")
    endif()
